...
# read txt file
AgNP_df = pd.read_csv('raw_data/UV-Vis-Jun9/AgNP_Absorbance_Jun9.txt', header=None, skiprows=range(35), sep='\t')
wavelen1, abs1 = AgNP_df[0], AgNP_df[1]
Au_Ag_df = pd.read_csv('raw_data/UV-Vis-Jun9/Au@Ag_Absorbance_Jun9.txt', header=None, skiprows=range(35), sep='\t')
...
plt.title('UV-Vis spectra of AgNPs')
# find peak for AgNP
...
plt.savefig('fig_gallery/UV-Vis spectra of AgNPs.png')
plt.show()
...
plt.xlabel('Wavelength (nm)')
plt.ylabel('Absorbance (arb.units)')
plt.title('UV-Vis spectra of Au@Ag')
...
plt.savefig('fig_gallery/UV-Vis spectra of Au@Ag.png')
plt.show()
