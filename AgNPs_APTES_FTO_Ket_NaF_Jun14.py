...
path = 'raw_data/AgNPs_APTES_FTO_Ket'
...
plt.savefig('fig_gallery/AgNPs_APTES_FTO_Ket_100uM_NaF_0.1M_1.png')
plt.show()
...
plt.savefig('fig_gallery/AgNPs_APTES_FTO_Ket_100uM_NaF_0.1M_2.png')
plt.show()
...
plt.savefig('fig_gallery/AgNPs_APTES_FTO_Ket_100uM_NaF_0.1M_3.png')
plt.show()
