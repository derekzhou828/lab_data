...
path_gamry = 'raw_data/AgNPs_APTES_FTO_UA_100uM_CRN_0uM_R6G_10uM_Jul11/Potential_Sequence'
path_raman = 'raw_data/AgNPs_APTES_FTO_UA_100uM_CRN_0uM_R6G_10uM_Jul11/Scan_RamanShift'

df_all, df_mean = ReadData(path_gamry, path_raman)

df_all.to_csv('initial_process/AgNPs_UA_100uM_Jul11_all.csv', index=False)
df_mean.to_csv('initial_process/AgNPs_UA_100uM_Jul11_average.csv', index=False)
...
plt.savefig('fig_gallery/AgNPs_UA_100uM_Jul11_1.png')
plt.show()
