...
path_gamry = '../LabData_Derek/AuAgCoreShell_UA_100uM_CRN_0uM_R6G_10uM_Jun29/Potential_Sequence'
path_raman = '../LabData_Derek/AuAgCoreShell_UA_100uM_CRN_0uM_R6G_10uM_Jun29/Scan_RamanShift'

df_all, df_mean = ReadData(path_gamry, path_raman)

df_all.to_csv('../Data_csv/Au@AgCoreShell_UA_Jun29_all.csv', index=False)
df_mean.to_csv('../Data_csv/Au@AgCoreShell_UA_Jun29_average.csv', index=False)
...
plt.savefig('../Data_Fig/Au@AgCoreShell_UA_Jun29_1.png')
plt.show()
