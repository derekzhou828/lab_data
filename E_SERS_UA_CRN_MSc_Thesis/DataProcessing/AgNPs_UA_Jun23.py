...
path_gamry = '../LabData_Derek/AgNPs_APTES_FTO_UA_100uM_CRN_0uM_R6G_10uM_Jun23/Potential_Sequence'
path_raman = '../LabData_Derek/AgNPs_APTES_FTO_UA_100uM_CRN_0uM_R6G_10uM_Jun23/Scan_RamanShift'

df_all, df_mean = ReadData(path_gamry, path_raman)

df_all.to_csv('../Data_csv/AgNPs_UA_Jun23_all.csv', index=False)
df_mean.to_csv('../Data_csv/AgNPs_UA_Jun23_average.csv', index=False)
...
plt.savefig('../Data_Fig/AgNPs_UA_Jun23_1.png')
plt.show()
