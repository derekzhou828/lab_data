...
path_gamry = '../LabData_Derek/AgNPs_APTES_FTO_UA_50uM_CRN_0uM_R6G_10uM_Jul5/Potential_Sequence'
path_raman = '../LabData_Derek/AgNPs_APTES_FTO_UA_50uM_CRN_0uM_R6G_10uM_Jul5/Scan_RamanShift'

df_all, df_mean = ReadData(path_gamry, path_raman)

df_all.to_csv('../Data_csv/AgNPs_UA_50uM_Jul5_all.csv', index=False)
df_mean.to_csv('../Data_csv/AgNPs_UA_50uM_Jul5_average.csv', index=False)
...
plt.savefig('../Data_Fig/AgNPs_UA50uM_Jul5_1.png')
plt.show()
